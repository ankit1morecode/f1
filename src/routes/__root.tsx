  ...
  head: () => ({
    meta: [
      ...
      { title: "SlipStream-X — Live Race Engineering" },
      {
        name: "description",
        content:
          "Four-corner race engineering, live telemetry, circuit state, pit strategy and session analysis for SlipStream-X.",
      },
      { name: "author", content: "SlipStream-X" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Oxanium:wght@500;600;700&family=Barlow:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500&display=swap",
      },
